...
public class Equipment extends ItemContainer {
    ...
    /**
     * The jaw slot. This is used for various minigames [castle wars, soul wars, barbarian assault) to allow the usage of capes
     * on top of the icon/dedicated minigame cape. In soul wars and castle wars, there are different versions of the cape for each
     * facial hair style.
     */
