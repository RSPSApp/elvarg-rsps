...
public class FrozenTentacleCombatMethod extends MeleeCombatMethod {
    ...
    public void start(Mobile character, Mobile target) {
        CombatSpecial.drain(character, CombatSpecial.FROZEN_TENTACLE.getDrainAmount());
    ...
    public void handleAfterHitEffects(PendingHit hit) {
        ...
        CombatFactory.freeze(target, 20);
